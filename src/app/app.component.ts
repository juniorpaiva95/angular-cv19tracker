...
declare var covid_total_timeline: any;
declare var covid_world_timeline: any;
...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  worldStatistics: any;
  isLoadedChart: BehaviorSubject<boolean> = new BehaviorSubject(false);
  ...
  initChart() {
    ...
    am4core.ready(function () {
      ...
      am4core.ready(function () {
        ...
        // get slide data
        console.log(self);
        var slideData = self.getSlideData();
        ...
        slider.events.on("rangechanged", function (event) {
          ...
          updateMapData(self.getSlideData(index).list);
          updateTotals(index);
        })
